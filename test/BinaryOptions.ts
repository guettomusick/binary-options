...
const getRound = (index: number) => Math.floor(Date.now()/1000/INTERVAL)*INTERVAL + index*INTERVAL;
...
describe('BinaryOptions', function() {
  ...
  beforeEach(async () => {
    ...
    const EthPriceFeed = await deployMockContract(owner, AggregatorV3Interface.abi);
  ...
  describe('Place, Execute and Collect', () => {
