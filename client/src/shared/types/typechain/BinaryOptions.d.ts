...
interface BinaryOptionsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "lockBalance(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "lockBalance", values: [string]): string;
  encodeFunctionData(
...
export class BinaryOptions extends Contract {
  ...
  estimateGas: {
    ...
    lockBalance(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    unlock(amount: BigNumberish, overrides?: Overrides): Promise<BigNumber>;
