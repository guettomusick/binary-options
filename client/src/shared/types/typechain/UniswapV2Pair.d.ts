...
interface UniswapV2PairInterface extends ethers.utils.Interface {
  functions: {
    ...
    "_update(uint256,uint256,uint112,uint112)": FunctionFragment;
    ...
    "setData(uint112,uint112,uint32,uint256,uint256)": FunctionFragment;
...
export class UniswapV2Pair extends Contract {
  ...
  functions: {
    ...
    setData(
      _reserve0: BigNumberish,
      _reserve1: BigNumberish,
      _blockTimestampLast: BigNumberish,
      _price0CumulativeLast: BigNumberish,
      _price1CumulativeLast: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setData(uint112,uint112,uint32,uint256,uint256)"(
      _reserve0: BigNumberish,
      _reserve1: BigNumberish,
      _blockTimestampLast: BigNumberish,
      _price0CumulativeLast: BigNumberish,
